...
void PatternSolver::Initialize()
{
    ...
    ms_patterns[PATID_MKModifier_TeamConstructor] = GetPattern("E8 ? ? ? ? 4C 8B 75 97 49 63 BE ? ? ? ? 8D 47 01 41 89 86 ? ? ? ? 41 3B 86 ? ? ? ? 7E 0E 8B D7 49 8D 8E ? ? ? ? E8", 0);
    ...
    ms_patterns[PATID_TArray_Resize] = GetPattern("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 30 48 63 79 08 48 8B D9 8B EA", 0);
    ms_patterns[PATID_FightObjectOffset] = GetPattern("48 8B 89 ? ? ? ? 48 85 C9 74 0A 48 8B 01 48 FF A0 20 03 00 00", 3);
    ms_patterns[PATID_TeamModifiersOffset] = GetPattern("89 9F ? ? ? ? E8 ? ? ? ? 48 8B 18 E8 ? ? ? ? 4C 8B C8 C6 44 24 ? ? 4C 8B C0 C6 44 24 ? ? 48 8B D3 48 8B CF E8 ? ? ? ? 48 8B 5C 24 ? 48 89 87 ? ? ? ? 48 8B C7 48 83 C4 30 5F C3", 54);
...
const char* PatternSolver::GetPatternName(int id)
{
    ...
    "BulkData_Realloc",
    "FWeakObjectPtr_Get",
    "FWeakObjectPtr_Equal",
    "FWeakObjectPtr_IsValid",
    ...
    "ScriptAlloc",
    "MKModifier_GlobalConstructor",
    "MKModifier_TeamConstructor",
